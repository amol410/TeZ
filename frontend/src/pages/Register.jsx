...
import { BookOpen, GraduationCap, Sparkles, Mail, Lock, User } from 'lucide-react';
...
export default function Register() {
  ...
  const { loginWithGoogle, registerWithEmail, loading } = useAuth();
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">
            Join TezSend LMS and start learning today
          </p>
        </div>
        ...
        <div className="glass-card p-8 gradient-border">
          ...
          <form onSubmit={handleEmailRegister} className="space-y-4 mb-6">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-400 mb-1.5 ml-1">Full Name</label>
          ...
          <p className="text-center text-gray-500 text-sm mt-6">
            ...
            <Link to="/login" className="text-dolphin-400 hover:text-dolphin-300 font-medium">
              Sign in
            </Link>
          </p>
        </div>
